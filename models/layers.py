...
class GraphLayer(nn.Module):
    ...
    def forward(self, code_x, neighbor, c_embeddings, n_embeddings, time_weight):
        ...
        center_embeddings_p = center_embeddings * time_weight
        neighbor_embeddings = neighbor_codes * n_embeddings
        neighbor_embeddings_p = neighbor_embeddings * time_weight
        cc_embeddings = center_codes * torch.matmul(self.adj, center_embeddings_p)
        cn_embeddings = center_codes * torch.matmul(self.adj, neighbor_embeddings_p)
        nn_embeddings = neighbor_codes * torch.matmul(self.adj, neighbor_embeddings_p)
        nc_embeddings = neighbor_codes * torch.matmul(self.adj, center_embeddings_p)
