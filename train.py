...
if __name__ == '__main__':
    ...
    # dataloader_train = DataLoader(dataset=train_data, batch_size=batch_size, shuffle=False, num_workers=2, pin_memory=True)
    ...
    for epoch in range(epochs):
        ...
        for step in range(len(train_data)):
            optimizer.zero_grad()
            code_x, visit_lens, divided, y, neighbors, time_weight = train_data[step]
